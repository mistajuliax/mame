...
def EmitGroup04(f,funcname, opname, opexecute, opwrite, opwrite_alt, ignore_a, breg_is_dst_only, flagcondition, flaghandler):
        ...
        print(
            f"ARCOMPACT_RETTYPE arcompact_device::arcompact_handle{funcname}_p00(OPS_32)",
            file=f,
        )
        print("{", file=f)
        print("	int size = 4;", file=f)
        ...
        print(
            f"ARCOMPACT_RETTYPE arcompact_device::arcompact_handle{funcname}_p01(OPS_32)",
            file=f,
        )
        print("{", file=f)
        ...
        print(
            f"ARCOMPACT_RETTYPE arcompact_device::arcompact_handle{funcname}_p10(OPS_32)",
            file=f,
        )
        if ignore_a == 2:
                print("{", file=f)
        ...
        print(
            f"ARCOMPACT_RETTYPE arcompact_device::arcompact_handle{funcname}_p11_m0(OPS_32)",
            file=f,
        )
        if ignore_a == 2:
            print("{", file=f)
        ...
        print(
            f"ARCOMPACT_RETTYPE arcompact_device::arcompact_handle{funcname}_p11_m1(OPS_32)",
            file=f,
        )
        if ignore_a == 2:
                print("{", file=f)
...
def EmitGroup0d(f,funcname, opname, opexecute, opwrite):
        print(
            f"ARCOMPACT_RETTYPE arcompact_device::arcompact_handle{funcname}(OPS_16)",
            file=f,
        )
        print("{", file=f)
